...
SELECT
    ...
    customer_no,
    dt_load_date,
    dt_start_date, -- Fecha en la que el registro empieza a ser válido
    dt_end_date,   -- Fecha en la que el registro deja de ser válido
    current_record, -- Indicador de si el registro es el actual
    first_name,
    last_name,
    full_name,
    social_scrty_no,
