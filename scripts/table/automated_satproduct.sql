...
INSERT INTO satproduct (
    hashkeyproducto,
    dt_load_date,
    dt_start_date, -- Date when the record becomes effective
    dt_end_date,   -- Date when the record is no longer effective
    current_record, -- Indicator if the record is the current one
    cd_product,
    ds_product,
    cd_package_group,
    ds_package_group,
