...
--Precondiciones: Los valores de product_id y customer_id deben existir en las tablas HubProduct y hubcustomer, respectivamente.
--Pasos:

-- Ejecutar la siguiente instrucción SQL:
INSERT INTO linkproductocustomer (link_key, product_id, customer_id, dt_transaction_date, dt_load_date, recordsource)
...
--Caso de Prueba 3: Integridad Referencial para customer_id
--Descripción: Verificar que customer_id debe existir en la tabla hubcustomer.
--Pasos:
--Ejecutar la siguiente instrucción SQL:
...
--Resultado : La base de datos devuelve un error de clave externa indicando que customer_id no existe.

--Caso de Prueba 4: Integridad Referencial para product_id
--Descripción: Verificar que product_id debe existir en la tabla HubProduct.
--Pasos:
--Ejecutar la siguiente instrucción SQL:
...
--Resultado: La base de datos devuelve un error de clave externa indicando que product_id no existe.
